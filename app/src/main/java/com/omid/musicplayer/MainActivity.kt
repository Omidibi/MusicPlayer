            ...
            downSlide.uiPlayer.playPause.setOnClickListener {
                if (!player.isPlaying) {
                    if (player.playbackState == Player.STATE_ENDED) {
                        ...
                        player.setMediaItem(MediaItem.fromUri(Uri.parse(latestMp3.mp3Url.toString())))
                        player.prepare()
                    }
                    player.play()
    ...
    private fun fragmentStatusInActivity() {
        binding.apply {
            ...
            sharedViewModel.latestMp3List.observe(this@MainActivity) { latestMp3List ->
                ...
                downSlide.uiPlayer.rvListSong.adapter = SongListSlidingUpPanelAdapter(latestMp3List,object : ISend {
