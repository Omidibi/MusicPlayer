...
class PlaylistByIdAdapter(private val playlistByIdMp3: List<LatestMp3>, private val iSelected: IOnSongClickListener, private val fragment: Fragment) : RecyclerView.Adapter<PlaylistByIdAdapter.PlaylistByIdVH>() {
    ...
    override fun onBindViewHolder(holder: PlaylistByIdVH, position: Int) {
        holder.apply {
            ...
            ivShare.setOnClickListener {
                Share.shareMusic(playlistByIdInfo, fragment)
            }
        }
    }
}